...
class ConfigResponseNitro {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('primary_language')) {
                obj['primary_language'] = ApiClient.convertToType(data['primary_language'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['primary_language'] && !(typeof data['primary_language'] === 'string' || data['primary_language'] instanceof String)) {
            throw new Error("Expected the field `primary_language` to be a primitive type in the JSON string but got " + data['primary_language']);
        }
 ...
 * @member {String} primary_language
 */
ConfigResponseNitro.prototype['primary_language'] = undefined;
