...
/**
 * The FieldImage model module.
 * @module model/FieldImage
 * @version 1.0.0-beta.197
 */
class FieldImage {
    /**
     * Constructs a new <code>FieldImage</code>.
     * @alias module:model/FieldImage
     */
    constructor() { 
        
        FieldImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FieldImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FieldImage} obj Optional instance to populate.
     * @return {module:model/FieldImage} The populated <code>FieldImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FieldImage();
    ...
    /**
     * Validates the JSON data with respect to <code>FieldImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldImage</code>.
     */
 ...
 */
FieldImage.prototype['source'] = undefined;

/**
 * Describes the file or image
 * @member {String} caption
 */
FieldImage.prototype['caption'] = undefined;

/**
 * @member {String} copyright
 */
FieldImage.prototype['copyright'] = undefined;

/**
 * @member {String} name
 */
FieldImage.prototype['name'] = undefined;

/**
 * The unique identifier of the file or image as incremental number.
 * @member {Number} id
 */
FieldImage.prototype['id'] = undefined;
