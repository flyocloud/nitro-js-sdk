...
/**
 * The ContainerPage model module.
 * @module model/ContainerPage
 * @version 2.28
 */
class ContainerPage {
    /**
     * Constructs a new <code>ContainerPage</code>.
     * @alias module:model/ContainerPage
     */
    constructor() { 
        
        ContainerPage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContainerPage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContainerPage} obj Optional instance to populate.
     * @return {module:model/ContainerPage} The populated <code>ContainerPage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContainerPage();
            ...
            if (data.hasOwnProperty('children')) {
                obj['children'] = ApiClient.convertToType(data['children'], [ContainerPage]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContainerPage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContainerPage</code>.
     */
    static validateJSON(data) {
        ...
        if (data['children']) { // data not null
            ...
            for (const item of data['children']) {
                ContainerPage.validateJSON(item);
            };
        }
 ...
 * @member {module:model/ContainerPage.TypeEnum} type
 */
ContainerPage.prototype['type'] = undefined;

/**
 * can be either _self (which is default) or _blank
 * @member {String} target
 */
ContainerPage.prototype['target'] = undefined;

/**
 * @member {String} label
 */
ContainerPage.prototype['label'] = undefined;
 ...
 * @member {String} href
 */
ContainerPage.prototype['href'] = undefined;
 ...
 * @member {String} slug
 */
ContainerPage.prototype['slug'] = undefined;

/**
 * @member {Object.<String, Object>} properties
 */
ContainerPage.prototype['properties'] = undefined;
 ...
 * @member {Array.<module:model/ContainerPage>} children
 */
ContainerPage.prototype['children'] = undefined;
