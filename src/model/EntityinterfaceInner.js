    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('routes')) {
                obj['routes'] = Routes.constructFromObject(data['routes']);
            }
        }
        return obj;
    }
 ...
 */
EntityinterfaceInner.prototype['updated_at'] = undefined;
 ...
 * @member {String} href
 */
EntityinterfaceInner.prototype['href'] = undefined;

/**
 * @member {module:model/Routes} routes
 */
