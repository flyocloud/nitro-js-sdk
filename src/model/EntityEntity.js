...
import EntityEntityEntityMetric from './EntityEntityEntityMetric';
...
class EntityEntity {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('entity_metric')) {
                obj['entity_metric'] = EntityEntityEntityMetric.constructFromObject(data['entity_metric']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['entity_metric']) { // data not null
          EntityEntityEntityMetric.validateJSON(data['entity_metric']);
        }
 ...
 */
EntityEntity.prototype['_version'] = undefined;

/**
 * @member {module:model/EntityEntityEntityMetric} entity_metric
 */
EntityEntity.prototype['entity_metric'] = undefined;

/**
 * @member {String} entity_unique_id
 */
EntityEntity.prototype['entity_unique_id'] = undefined;

/**
 * @member {String} entity_id
 */
EntityEntity.prototype['entity_id'] = undefined;

/**
 * @member {String} entity_image
 */
EntityEntity.prototype['entity_image'] = undefined;

/**
 * @member {String} entity_slug
 */
EntityEntity.prototype['entity_slug'] = undefined;

/**
 * @member {String} entity_teaser
 */
EntityEntity.prototype['entity_teaser'] = undefined;

/**
 * @member {String} entity_time_end
 */
EntityEntity.prototype['entity_time_end'] = undefined;

/**
 * @member {String} entity_time_start
 */
EntityEntity.prototype['entity_time_start'] = undefined;

/**
 * @member {String} entity_title
 */
EntityEntity.prototype['entity_title'] = undefined;

/**
 * @member {String} entity_type
 */
EntityEntity.prototype['entity_type'] = undefined;

/**
 * @member {Number} entity_type_id
 */
EntityEntity.prototype['entity_type_id'] = undefined;

/**
 * @member {String} updated_at
 */
EntityEntity.prototype['updated_at'] = undefined;

/**
 * @member {Object.<String, String>} routes
 */
EntityEntity.prototype['routes'] = undefined;
