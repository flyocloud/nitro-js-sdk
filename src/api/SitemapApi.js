...
export default class SitemapApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/Sitemap200ResponseInner>} and HTTP response
     */
    sitemapWithHttpInfo() {
      let postBody = null;
      ...
      let returnType = [Sitemap200ResponseInner];
     ...
     * Get Sitemap
     * Get all entities to build a sitemap. Pages are not included.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/Sitemap200ResponseInner>}
     */
    sitemap() {
